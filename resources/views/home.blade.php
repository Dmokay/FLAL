            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="clients-image style">
                            <div class="item-img">
                                <img src="{{asset('images/client/c2.png')}}" alt="images">
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="clients-image style">
                            <div class="item-img">
                                <img src="{{asset('images/client/c3.png')}}" alt="images">
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="clients-image style">
                            <div class="item-img">
                                <img src="{{asset('images/client/c4.png')}}" alt="images">
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="clients-image style">
                            <div class="item-img">
                                <img src="{{asset('images/client/c5.png')}}" alt="images">
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="clients-image style">
                            <div class="item-img">
                                <img src="{{asset('images/client/c6.png')}}" alt="images">
                            </div>
